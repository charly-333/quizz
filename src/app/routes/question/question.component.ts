...
export class QuestionComponent implements OnInit {
  ...
  submit() {
    ...
    // console.log('this.quizz.current.questions[this.quizz.progress.questionId].correctAnswer',
    // this.quizz.current.questions[this.quizz.progress.questionId].correctAnswer);
